...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        // Case 3: 9번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글은 존재하지 않으므로 댓글이 없습니다.");
        }
        ...
        // Case 4: 999번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글은 존재하지 않으므로 댓글이 없습니다.");
        }
        ...
        // Case 5: -1번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 글은 존재하지 않으므로 댓글이 없습니다.");
        }
    }
    ...
    void findByNickname() {
        // Case 1: "Park"의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList(a, b, c);
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "Park 의 댓글 모두 출력");
        }
        ...
        // Case 2: "Kim"의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList(a, b, c);
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "Kim 의 댓글 모두 출력");
        }
        ...
        // Case 3: null 의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "null 의 댓글 모두 출력");
        }
        ...
        // Case 4: "" 의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "\"\" 의 댓글 모두 출력");
        }
    }
}